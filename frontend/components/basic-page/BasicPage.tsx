      ...
      <div className="basic-page">
        <nav className="basic-page__nav">
          ...
          <div className="basic-page__nav-user-info">
              <Icon medium>person</Icon> <span>user1</span><span> Wyloguj </span>
          </div>
        </nav>
        ...
        <footer className="basic-page__footer">
            <div className="basic-page__footer-column">
                ...
                <p><a>Hodowle</a></p>
                <p><a>Weterynarze</a></p>
                <p><a>Psy na sprzedaż</a></p>
            </div>
            <div className="basic-page__footer-column">
                <div className="basic-page__footer-column-title">FAQ</div>
                <p><a>Mam psa, co dalej?</a></p>
                <p><a>Mam hodowlę, co dalej?</a></p>
                <p><a>Jestem weterynarzem, co dalej?</a></p>
                <p><a>Chcę psa, co dalej?</a></p>
                <p><a>Lubię psy, co dalej?</a></p>
            </div>
            <div className="basic-page__footer-column">
                <div className="basic-page__footer-column-title">Kontakt</div>
                <p><a>Formularz kontaktowy</a></p>
            </div>
        </footer>
      </div>
    );
